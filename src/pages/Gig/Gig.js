    ...
    <div className='gig'>
      <div className='gigContainer'>
        <div className='gigLeft'>
          <span className='gighead'>FIVERR > GRAPHICS & DESIGN > </span>
          ...
          <Slider {...settings} className="gigSlider">
            <img
